...
'LBL_LANG_1'=> 'Вы можете или установить языковой пакет, отличающийся от установленного по умолчанию (US-English), или нажать на кнопку "Вперёд" для продолжения процесса установки.' ,
...
'LBL_SITECFG_ADMIN_PASS_WARN'=> 'Осторожно: произойдёт перезапись пароля администратора любой предыдущей установки SugarCRM.' ,
...
'LBL_SITECFG_PASSWORD_MSG'          => 'После установки системы необходимо войти в Sugar под учётной записью администратора . После входа в систему вы можете сменить указанные при установке логин и пароль администратора системы.',
...
<li> <b>СУБД</b> &#8211; должна быть установлена MySQL либо  SQL
Server</li>
...
<ul>
<li> <b>Тип СУБД</b>, в которой будут храниться данные приложения  <ul><li>MySQL или MS SQL Server.<br><br></li></ul></li>
...
'subject' => 'Sugar - информация о созданной учётной записи',
'description' => 'Данный шаблон используется при отправке пользователю письма, содержащего новый пароль для доступа к системе.',
'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>В данном письме содержатся Ваш логин и временный пароль для доступа к Sugar:</p><p>Логин: $contact_user_user_name </p><p>Пароль: $contact_user_user_hash </p><br><p>$config_site_url</p><br><p>После регистрации в системе настоятельно рекомендуется сменить данный временный пароль на новый.</p>   </td>         </tr><tr><td colspan=\"2\"></td>         </tr> </tbody></table> </div>',
'txt_body' =>
'
...
'subject' => 'Sugar - сброс пароля пользователя',
