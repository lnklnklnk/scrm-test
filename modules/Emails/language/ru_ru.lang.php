...
'LBL_TEST_EMAIL_SUBJECT' => 'Sugar - тест настроек электронной почты',
'LBL_NO_SUBJECT' => '(без темы)',
'LBL_CHECKING_ACCOUNT'=> 'Проверка учётной записи',
'LBL_OF'=> 'из',
'LBL_TEST_EMAIL_BODY' => 'Это сообщение было отправлено с целью проверки настроек сервера исходящей почты Sugar. Успешное получение этого письма свидетельствует о корректных настройках сервера исходящей почты.',
