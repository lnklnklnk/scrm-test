...
'LBL_PHONE'=> 'Тел.:' ,
'LBL_PICK_TZ_WELCOME'=> 'Добро пожаловать в SugarSuite' ,
...
'LBL_REMINDER_TEXT'=> 'Временной интервал по умолчанию для напоминания о предстоящем телефонном разговоре или встрече. Напоминания в виде всплывающих окон появляются у всех приглашённых пользователей Sugar. Напоминания по электронной почте отправляются ВСЕМ приглашённым.' ,
...
'LBL_SUGAR_LOGIN'=> 'Пользователь SugarCRM',
...
'LBL_YOUR_PUBLISH_URL'=> 'Опубликовать в моем размещении' ,
    ...
    'LBL_ICAL_PUB_URL_HELP'             => 'Используйте этот адрес для подписки на календарь Sugar в рамках iCal.',
...
<tr><td><!--not_in_theme!--><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/university" target="_blank"><b>Sugar University</b></a><br>Доступ к учебным материалам</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="http://docs.sugarcrm.com/" target="_blank"><b>Англоязычная документация</b></a><br>Официальная онлайн-документация.</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/kb.png style="margin-right: 5px;"></td><td><a href="http://kb.sugarcrm.com/" target="_blank"><b>База знаний</b></a><br>Сборник статей, посвященных SugarCRM, а также ответы на часто задаваемые вопросы.</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Форум</b></a><br>Официальный форум, посвященный SugarCRM.</td></tr>
</table>',
...
'LBL_WIZARD_FINISH11' => 'Посещение сайта Sugar University',
'LBL_WIZARD_FINISH12' => 'Доступ к англоязычным учебным материалам. Ссылки на переведённую документацию вы можете посмотреть на <a href="http://www.sugarcrm.com.ua/viewforum.php?f=5" target="_blank"><b>Русскоязычном форуме, посвящённом SugarCRM</b></a>.',
