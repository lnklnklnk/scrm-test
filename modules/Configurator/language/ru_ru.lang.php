...
'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Установка минимального интервала автообновления раздела (дашлета). Выберите "Никогда", если необходимо отключить автоматическое обновление.',
...
'SHOW_DOWNLOADS_TAB_HELP' => 'Отображение закладки загрузок в настройках пользователя, обеспечивая доступ пользователя к плагинам и другим файлам Sugar',
