...
'LBL_LAST_RUN' => 'Последняя запущенная' ,
...
'LBL_STATUS' => 'Статус:' ,
'LBL_TIME_FROM' => 'Задача активна с' ,
'LBL_TIME_TO' => 'Задача активна до' ,
...
'LBL_CRON_LINUX_DESC' => 'Примечание: Для запуска планировщика Sugar добавьте эту строку в файл crontab: ',
'LBL_CRON_WINDOWS_DESC' => 'Примечание: Для запуска планировщика Sugar создайте пакетный файл и ежеминутно выполняйте его при помощи планировщика Windows. Пакетный файл должен содержать следующие команды: ',
